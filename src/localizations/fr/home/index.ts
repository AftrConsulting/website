const frHomeLocale = {
    ...
    quotes: {
        ...
        title: 'Nous garantissons une satisfaction de 100% à nos clients.\u00A0🤩'
    },
    services: {
        step1: {
    ...
    talkExpert: {
        ...
        description: `Nous vous fournirons toutes les informations, répondrons à toutes vos questions et 
		              vous donneront une estimation du prix gratuitement directement via notre chat.`,
        subTitle: 'Contactez-nous',
        title: 'Timide? 🙈 Parlez avec un expert en ligne.'
    }
};
